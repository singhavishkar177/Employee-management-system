...
import com.example.Employeemanagementsystem.payload.JWTAuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<JWTAuthResponse> login(@RequestBody LoginDto loginDto) throws ParseException {
